...
function fashion_designer_widgets_init() {
	...
	register_sidebar( array(
		...
		'description'   => __( 'Appears on single product page', 'fashion-designer' ),
...
function fashion_designer_scripts() {	
	...
	wp_enqueue_style( 'fashion-designer-block-style', get_theme_file_uri('/assets/css/blocks.css') );
	wp_enqueue_style( 'fashion-designer-block-patterns-style-frontend', get_theme_file_uri('/inc/block-patterns/css/block-frontend.css') );
	...
	wp_add_inline_style( 'fashion-designer-basic-style',$fashion_designer_custom_css );
	...
	wp_enqueue_script( 'fashion-designer-custom-scripts-jquery', esc_url(get_template_directory_uri()) . '/assets/js/custom.js', array('jquery') );
 ...
 */
function fashion_designer_block_editor_styles() {
	wp_enqueue_style( 'fashion-designer-font', fashion_designer_font_url(), array() );
    wp_enqueue_style( 'fashion-designer-block-patterns-style-editor', get_theme_file_uri( '/inc/block-patterns/css/block-editor.css' ), false, '1.0', 'all' );
    wp_enqueue_style( 'bootstrap-style', esc_url(get_template_directory_uri()).'/assets/css/bootstrap.css' );
    wp_enqueue_style( 'font-awesome-css', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css' );
}
add_action( 'enqueue_block_editor_assets', 'fashion_designer_block_editor_styles' );
...
function fashion_designer_sanitize_float( $input ) {
	return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
}

function fashion_designer_sanitize_number_range( $number, $setting ) {
...
function fashion_designer_sanitize_phone_number( $phone ) {
...
//define
define('FASHION_DESIGNER_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-fashion-designer/','fashion-designer'));
define('FASHION_DESIGNER_SUPPORT',__('https://wordpress.org/support/theme/fashion-designer/','fashion-designer'));
define('FASHION_DESIGNER_REVIEW',__('https://wordpress.org/support/theme/fashion-designer/reviews/','fashion-designer'));
define('FASHION_DESIGNER_BUY_NOW',__('https://www.vwthemes.com/themes/fashion-designer-wordpress-theme/','fashion-designer'));
define('FASHION_DESIGNER_LIVE_DEMO',__('https://www.vwthemes.net/vw-fashion-designer-pro/','fashion-designer'));
define('FASHION_DESIGNER_PRO_DOC',__('https://www.vwthemesdemo.com/docs/vw-fashion-designer-pro/','fashion-designer'));
define('FASHION_DESIGNER_FAQ',__('https://www.vwthemes.com/faqs/','fashion-designer'));
define('FASHION_DESIGNER_CHILD_THEME',__('https://developer.wordpress.org/themes/advanced-topics/child-themes/','fashion-designer'));
define('FASHION_DESIGNER_CONTACT',__('https://www.vwthemes.com/contact/','fashion-designer'));
define('FASHION_DESIGNER_CREDIT',__('https://www.vwthemes.com/themes/free-fashion-wordpress-theme/','fashion-designer'));
...
add_filter('loop_shop_columns', 'fashion_designer_loop_columns');
	...
	function fashion_designer_loop_columns() {
		return get_theme_mod( 'fashion_designer_products_per_row', '3' ); 
		// 3 products per row
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'fashion_designer_products_per_page' );
function fashion_designer_products_per_page( $cols ) {
  	return  get_theme_mod( 'fashion_designer_products_per_page',9);
}
